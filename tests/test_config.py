...
from brainshape.config import Settings, export_api_keys
...
class TestSettings:
    def test_defaults(self, monkeypatch):
        ...
        assert s.surrealdb_path == "~/.config/brainshape/surrealdb"
        assert s.notes_path == "~/brainshape"
...
class TestExportApiKeys:
    def test_exports_anthropic_key(self, monkeypatch):
        ...
        with patch("brainshape.settings.load_settings") as mock_load:
