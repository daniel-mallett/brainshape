...
export const MONOCHROME_LIGHT: Theme = {
  ...
  "editor-selection": "#d4d4d4", "editor-cursor": "#1a1a1a",
...
export const GRUVBOX_LIGHT: Theme = {
  ...
  "editor-selection": "#d5c4a1", "editor-cursor": "#3c3836",
...
export const TOKYO_NIGHT_LIGHT: Theme = {
  ...
  "editor-selection": "#c1c2c7", "editor-cursor": "#343b59",
...
export const CATPPUCCIN_LIGHT: Theme = {
  ...
  "editor-selection": "#ccd0da", "editor-cursor": "#4c4f69",
...
export const NORD_LIGHT: Theme = {
  ...
  "editor-selection": "#d8dee9", "editor-cursor": "#2e3440",
...
export const EVERFOREST_LIGHT: Theme = {
  ...
  "editor-selection": "#e6e2cc", "editor-cursor": "#5c6a72",
